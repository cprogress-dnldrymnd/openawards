...
?>
    <div class="team-slider <?= $style ?>">
        ...
        <div class="swiper team-swiper swiper-button-style-1">
                        ...
                        <div class="inner">
                            <div class="image-box">
                                ...
                                <?php if ($style == 'style-3') { ?>
                                    <button type="button" class="button-trigger team-modal-trigger" aria-label="<?= esc_attr(sprintf('Read more about %s', $team->post_title)) ?>" position="<?= $position ?>" linkedin="<?= $linked_in ?>" image="<?= wp_get_attachment_image_url(get_post_thumbnail_id($team->ID), 'Medium') ?>" team_name="<?= $team->post_title ?>" content="<?= wpautop($team->post_content) ?>" data-bs-toggle="modal" data-bs-target="#teamModal">
                                    </button>
                                <?php } ?>
                            </div>
                            <div class="content-box">
                                <?php if ($style != 'style-3') { ?>
                                    <button type="button" class="button-trigger team-modal-trigger" aria-label="<?= esc_attr(sprintf('Read more about %s', $team->post_title)) ?>" position="<?= $position ?>"  <?php if ($linked_in) { ?> linkedin="<?= $linked_in ?>"  <?php } ?> image="<?= wp_get_attachment_image_url(get_post_thumbnail_id($team->ID), 'Medium') ?>" team_name="<?= $team->post_title ?>" content="<?= wpautop($team->post_content) ?>" data-bs-toggle="modal" data-bs-target="#teamModal">
                                    </button>
                                <?php } ?>
                                ...
                                <div class="socials">
                                    <?php if ($linked_in) { ?>
                                        <a href="<?= $linked_in ?>" target="_blank" rel="noopener" aria-label="<?= esc_attr(sprintf('%s on LinkedIn (opens in a new tab)', $team->post_title)) ?>">
            ...
            <div class="swiper-pagination swiper-pagination-team d-block d-lg-none mt-4"></div>
        </div>
    </div>
<?php
    return ob_get_clean();
