                    ...
                    <div class="swiper-slide">
                        <div class="inner">
                            ...
                            <div class="content-box">
                                <?php if ($style != 'style-3') { ?>
                                    <button class="button-trigger team-modal-trigger" position="<?= $position ?>"  <?php if ($linked_in) { ?> linkedin="<?= $linked_in ?>"  <?php } ?> image="<?= wp_get_attachment_image_url(get_post_thumbnail_id($team->ID), 'Medium') ?>" team_name="<?= $team->post_title ?>" content="<?= wpautop($team->post_content) ?>" data-bs-toggle="modal" data-bs-target="#teamModal">
                                    </button>
                                <?php } ?>
