                ...
                <?php foreach ($teams as $team) { ?>
                    ...
                    <div class="swiper-slide">
                        <div class="inner">
                            ...
                            <button class="content-box team-modal-trigger" image="<?= get_post_thumbnail_id($team->ID), 'Medium' ?>" title="<?= $post->post_title ?>" content="<?= wpautop($team->post_content) ?>" data-bs-toggle="modal" data-bs-target="#teamModal">
                                <div class="name">
                                    <?= $team->post_title ?>
                                </div>
