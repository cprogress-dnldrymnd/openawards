...
Refer to the [activity logs event IDs for WooCommerce](https://melapress.com/support/kb/wp-activity-log-list-event-ids/#yoast-seo) for a complete list of the changes the plugin can keep a log of.
...
Release notes: [Yoast SEO, WPForms & Gravity Forms activity log extension updates](https://melapress.com/wordpress-activity-log/releases/)
...
Release notes: [Improved coverage of Yoast SEO plugin multisite settings](https://melapress.com/wordpress-activity-log/releases/)
