...
1. Install the [WP Activity Log plugin](https://melapress.com/wordpress-activity-log/)
...
Refer to the [activity logs event IDs for WooCommerce](https://melapress.com/support/kb/wp-activity-log-list-event-ids/#woocommerce) for a complete list of the changes the plugin can keep a log of.
...
* **New activity log event IDs**
	* Even ID 9154: User opened a WooCommerce order in the editor.
	* Event IDs 9140 up to 9143 are used to keep a log of changes to Shipping options.
	* Event IDs 9144 up to 9153 to keep a log of changes to the Accounts & Privacy store settings.
...
Release notes: [Announcing Activity log for WooCommerce 1.4.0](https://melapress.com/wordpress-activity-log/releases/)
...
Release notes: [Activity log extensions for Yoast SEO, WooCommerce & WPForms get a maintenance update](https://melapress.com/wordpress-activity-log/releases/)
...
Release notes: [Major update of all the activity log extensions](https://melapress.com/wordpress-activity-log/releases/)

* **Improvement**
	* Events now use the latest event format used in [WP Activity Log](https://melapress.com/wordpress-activity-log/).
...
Release notes: [Logs of software downloads & more reliable code](https://melapress.com/wordpress-activity-log/releases/)
...
* **Improvements**
	* Replaced old code with new standard template code for all [WP Activity Log extensions](hhttps://melapress.com/wordpress-activity-log/) (more stable and efficient code).
	* Moved most of the front-end from the [WP Activity Log](https://melapress.com/wordpress-activity-log/releases/) plugin.
...
Release notes: [New activity log extension for WooCommerce](https://melapress.com/wordpress-activity-log/releases/)
