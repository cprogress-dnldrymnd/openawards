...
Redux::set_section(
	$opt_name,
	array(
		'title' => __( 'Header', 'your-textdomain-here' ),
		'id'    => 'header',
		'desc'  => __( 'Header options', 'your-textdomain-here' ),
		'icon'  => 'el el-home',
		'fields' => array(
			array(
				'id'       => 'opt-logo',
				'type'     => 'media', 
				'url'      => true,
				'title'    => __('Colored Logo', 'redux-framework-demo'),
			),
		),
	)
);
...
$section = array(
	...
	'id'     => 'basic',
	'desc'   => esc_html__( 'Footer options', 'your-textdomain-here' ),
	'icon'   => 'el el-home',
	'fields' => array(
		array(
			'id'       => 'opt-logo-white',
			'type'     => 'media', 
			'url'      => true,
			'title'    => __('Logo for Dark Backgrounds', 'redux-framework-demo'),
		),
		array(
			'id'       => 'opt-location',
			'type'     => 'textarea', 
		...
		array(
			...
			'type'     => 'text', 
			'url'      => true,
			'title'    => __('Cookies Policy Link', 'redux-framework-demo'),
		),
		array(
			'id'       => 'opt-privacy',
			'type'     => 'text', 
			'url'      => true,
			'title'    => __('Privacy Policy Link', 'redux-framework-demo'),
		),
		array(
			'id'       => 'opt-additional-1-text',
			'type'     => 'text', 
			'url'      => true,
			'title'    => __('Additional Link Text 1', 'redux-framework-demo'),
		),
		array(
			'id'       => 'opt-additional-1-url',
			'type'     => 'text', 
			'url'      => true,
			'title'    => __('Additional Link Url 1', 'redux-framework-demo'),
		),
		array(
			'id'       => 'opt-additional-2-text',
			'type'     => 'text', 
			'url'      => true,
			'title'    => __('Additional Link Text 2', 'redux-framework-demo'),
		),
		array(
			'id'       => 'opt-additional-2-url',
			'type'     => 'text', 
			'url'      => true,
			'title'    => __('Additional Link Url 2', 'redux-framework-demo'),
		),
	),
);
...
$section = array(
	'title' => __( 'Footer', 'your-textdomain-here' ),
	'id'    => 'basic',
	'desc'  => __( 'Footer options', 'your-textdomain-here' ),
	'icon'  => 'el el-home',
);
