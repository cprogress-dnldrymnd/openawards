	...
	<div id="content" role="main" class="span8 offset2">
		...
		<section class="archive-section position-relative">
			<div class="container">
				...
				<div class="vc_btn3-container custom-button text-center mt-5 load-more">
					<a class="vc_general vc_btn3 vc_btn3-size-lg vc_btn3-shape-rounded vc_btn3-style-modern vc_btn3-color-violet" href="#" title="">
						<span>Load More</span>
